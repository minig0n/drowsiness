...
whenet = onnxruntime.InferenceSession(
    f'saved_model_224x224/whenet_1x3x224x224_prepost.onnx',
    providers=[
...
videoWriter = cv2.VideoWriter('video.mp4', fourcc, 30.0, (320, 260))
...
while True:
    ...
    for face in faces:
        ...
        for landmark in landmarks:
            cv2.circle(frame, landmark, 5, (0, 0, 255), -1, cv2.LINE_AA)
